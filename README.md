...
- Arrow keys or `W` / `A` / `S` / `D`: move in any direction
- Space: shoot when the goal/hoop glows and `SHOOT NOW!` appears
- Touch: swipe in any direction to move, tap to shoot
...
- Score, coins, streaks, celebrations, and funny fail messages
- Simple sound effects with mute toggle
